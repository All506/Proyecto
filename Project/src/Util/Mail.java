...
public class Mail {
    ...
    private static Message sendEmailRegister(Session session, String myAccountEmail, String recepient, String[] data) throws IOException, ListException {
    ...
    //Metodo para enviar el correo de matricula de cursos
    private static Message sendEmailEnrollment(Session session, String myAccountEmail, String recepient, String[] data, String course) throws IOException, ListException {
        String[] dataName = {"Student Identification", "Identification", "Carrer Identification", "Last Name", "First Name", "Phone Number", "Email", "Address", "Birthday"};
        try {
            Message message = new MimeMessage(session);
            message.setFrom(new InternetAddress(myAccountEmail));
    ...
    //Metodo para enviar el correo de retiro de cursos
    private static Message sendEmailDeEnrollment(Session session, String myAccountEmail, String recepient, String[] data, String reasonDenEnrollment, String course) throws IOException, ListException {
        String[] dataName = {"Student Identification", "Identification", "Carrer Identification", "Last Name", "First Name", "Phone Number", "Email", "Address", "Birthday"};
        try {
            Message message = new MimeMessage(session);
            message.setFrom(new InternetAddress(myAccountEmail));
